...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["yes love?", "admin ko tawagin mo beh", "ang pogi ng owner ko beh", "wag ako tawagin mo yong admin ko nalang.", "yes, hello baby wife :3", "yes master?", "dun ka sa admin ko", "ano nanaman?", "nandito lang ako lagi mahal", "mahalin mo na admin ko beh"];
