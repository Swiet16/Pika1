...
Hi My Name Is ${global.config.BOTNAME}
My Prefix Is [ ${global.config.PREFIX} ]
Type ${global.config.PREFIX}help to see my command list.
My Owner Is Erythel Vior Kindly Use ${global.config.PREFIX}callad For Any Issues Or Concerns;
